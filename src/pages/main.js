    ...
    return (
        <div>
            <div>
                ...
                <a href="https://zigzag.kr/partners/">
                    <img className="new" src={require("../image/new.png")} />
                </a>
                <a href="https://shop.zigzag.kr/#!/login">
                    <img className="login" src={require("../image/login.png")} />
                </a>
                {/*<img className="picture3" src={require("../image/picture3.png")} />*/}
                {/*<img className="picture4" src={require("../image/picture4.png")} />*/}
                {/*<img className="picture5" src={require("../image/picture5.png")} />*/}
            </div>
